...
include { BCFTOOLS_CALL } from '/Users/pauline.fourgoux/Documents/Code/nf-dnaseq/modules/bcftools/call/tests/../main.nf'
...
workflow {
    ...
    if (BCFTOOLS_CALL.output){

        // consumes all named output channels and stores items in a json file
        for (def name in BCFTOOLS_CALL.out.getNames()) {
            serializeChannel(name, BCFTOOLS_CALL.out.getProperty(name), jsonOutput)
        }	  
      
        // consumes all unnamed output channels and stores items in a json file
        def array = BCFTOOLS_CALL.out as Object[]
